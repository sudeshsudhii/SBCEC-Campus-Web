            ...
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-[#b30202] to-[#a00000] text-white p-8">
                        <h1 className="text-3xl md:text-4xl font-bold mb-2">Artificial Intelligence and Data Science</h1>
                        <p className="text-red-100">Department of AI & DS</p>
                    </div>
                            ...
                            <div className="md:col-span-2 space-y-6">
                                <section>
                                    ...
                                    <p className="text-gray-700 leading-relaxed mb-4">
                                        The Department of Artificial Intelligence and Data Science (AI&DS) is a new and emerging field
                                        that focuses on creating intelligent machines and extracting insights from data. This course
                                        combines Computer Science, Mathematics, and Statistics.
                                    </p>
                                    <p className="text-gray-700 leading-relaxed">
                                        Students will learn about Machine Learning, Deep Learning, Natural Language Processing, Big Data Analytics,
                                        and diverse applications of AI in healthcare, finance, and other sectors.
                                    </p>
                                </section>
                                ...
                                <section>
                                    ...
                                    <div className="bg-red-50 p-6 rounded-lg border-l-4 border-[#b30202] mb-4">
                                        ...
                                        <p className="text-gray-700">
                                            To be a leading center for education and research in Artificial Intelligence and Data Science.
                                        </p>
                                    </div>
                                    <div className="bg-red-50 p-6 rounded-lg border-l-4 border-[#b30202]">
                                        ...
                                        <ul className="list-disc list-inside text-gray-700 space-y-1">
                                            <li>To provide state-of-the-art infrastructure for learning and research in AI.</li>
                                            <li>To collaborate with industry for real-world problem solving.</li>
                                            <li>To create ethical AI practitioners and data scientists.</li>
                                        </ul>
                                    </div>
                                </section>
                            </div>
